...
<body>
    ...
    <div class="container">
        <?php if ($page == 'login'): ?>
            ...
            <div class="card">
                <h2 style="text-align: center; margin-bottom: 15px; font-size: 1.3rem;">Login Sistem</h2>
                ...
                <form method="POST">
                    <div class="form-group">
                        <label for="identifier"><i class="fas fa-user"></i> NIS / Username Admin</label>
                        <input type="text" id="identifier" name="identifier" required placeholder="Masukkan NIS atau username admin">
                    </div>
